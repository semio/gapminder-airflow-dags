...
def slack_report(context, status):
    ...
    context["target_dataset"] = "target_dataset"
...
with DAG(dag_id, default_args=default_args, schedule=schedule) as dag:
    ...
    branch_task = BranchPythonOperator(task_id="check_new_commit", python_callable=check_new_commit)
